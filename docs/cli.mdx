...
| ------- | ------------ | ------------------------------------------------------------------------------------------------------------ |
| Linux   | x86_64       | [Download](https://github.com/someengineering/fixctl/releases/download/0.0.8/fixctl-linux-amd64-0.0.8)       |
| Linux   | arm64        | [Download](https://github.com/someengineering/fixctl/releases/download/0.0.8/fixctl-linux-arm64-0.0.8)       |
| macOS   | Universal    | [Download](https://github.com/someengineering/fixctl/releases/download/0.0.8/fixctl-macos-universal-0.0.8)   |
| Windows | x86_64       | [Download](https://github.com/someengineering/fixctl/releases/download/0.0.8/fixctl-windows-amd64-0.0.8.exe) |
| Windows | arm64        | [Download](https://github.com/someengineering/fixctl/releases/download/0.0.8/fixctl-windows-arm64-0.0.8.exe) |
